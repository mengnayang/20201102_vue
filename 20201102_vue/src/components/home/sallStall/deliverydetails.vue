    ...
    <div class="return_wholesale_details">
        ...
        <el-card>
            ...
            <el-table :data="deliveryGoodList" border >
                ...
                <el-table-column label="商品编号" prop="deliveryStockGoodsId" fixed width="180" align="center"></el-table-column>
                ...
                <el-table-column label="批发单价" prop="deliveryPrice" width="140" align="center"></el-table-column>
                <el-table-column label="出库数量" prop="deliveryNum"  width="160" align="center"></el-table-column>
                <el-table-column label="销售单位" prop="unitName"  width="130" align="center"></el-table-column>
                <el-table-column  v-if="!flag" label="退货数量" prop="refundCustomerNum"  fixed="right" width="120" align="center">
                    <template slot-scope="scope">
                        <el-input v-model.number="scope.row.refundCustomerNum" @blur="onNumChange(scope.row)" placeholder="请输入内容" ></el-input>
                    </template>
                </el-table-column>
                <el-table-column v-if="!flag" label="退货单价" prop="refundCustomerPrice" fixed="right" width="120" align="center">
                    <template slot-scope="scope">
                        <el-input v-model.number="scope.row.refundCustomerPrice"  :placeholder="scope.row.deliveryPrice" @blur="onPriceChange(scope.row)"></el-input>
                    </template>
                </el-table-column>
    ...
    name:'Deliverydetails',
        ...
        methods:{
            getParams(){
                ...
                //订单类型为批发1 零售2
                this.refundCustomerRecord.orderType=1
            ...
            getDeliveryList() {
                ...
                // console.log(data)
                this.$axios.post('/deliveryreturn/deliverydetails', this.$qs.stringify(data),{
                    headers:{
            ...
            commitReturn(){
                ...
                for(let i=0;i<this.deliveryGoodList.length;i++){
                    currentList.push({
                        refundCustomerStockGoodsId:parseFloat(this.deliveryGoodList[i].deliveryStockGoodsId),
                ...
                console.log(data)
                this.$axios.post('/deliveryreturn/commit', this.$qs.stringify(data),{
                    headers:{
                        staffToken:window.sessionStorage.getItem('staffToken')
                    }
                })
