    ...
    <div class="search_store_container">
        ...
        <el-card>
            ...
            <el-row v-show="isFirst">
                ...
                <el-col :span="5">
                    <el-autocomplete value-key="goodsId" v-model="selected.selectedGoodsId" :fetch-suggestions="querySearchGoodsId" :maxlength="100" size="mini" placeholder="请输入查询的商品编号" clearable></el-autocomplete>
                </el-col>
                <el-col :span="2" :offset="1">
                    <span>商品名称:</span>
                </el-col>
                <el-col :span="5">
                    <el-autocomplete value-key="goodsName"  v-model="selected.selectedGoodsName" :fetch-suggestions="querySearchGoodsName" :maxlength="100" size="mini" placeholder="请输入查询的商品名称" clearable></el-autocomplete>
                </el-col>
            ...
            <el-row v-show="isFirst">
                ...
                <el-col :span="5">
                    <el-autocomplete value-key="goodsBrand" v-model="selected.selectedGoodsBrand" :fetch-suggestions="querySearchBrandsName" :maxlength="100" size="mini" placeholder="请输入查询的品牌类别" clearable></el-autocomplete>
                </el-col>
